...
\begin{tikzpicture}[x=1in,y=1in]
  ...
  \node[inner sep=0] at (2.5,2.25)
    {\includegraphics[width=2in]{wcu.jpg}};

  \node[inner sep=0,align=center] at (5.25,2.25)
    {
      \Large Hosted by \textbf{Western Carolina University} \\
      \large on \textbf{April 1, 2017} \\\\\\
      \large For teams of 9th-12th graders. \\
      \large Visit \textbf{MaPPmath.org} or \\
      \large contact Dr. Andrew Penland \\
      \large \(\langle\)adpenland@email.wcu.edu\(\rangle\)
             for details!
    };
